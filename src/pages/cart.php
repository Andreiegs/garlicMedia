                      ...
                      <tbody>
                        ...
                        <tr>
							...
							<td>
							  <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
								<div class="input-group-prepend">
								  <button class="btn btn-outline-black decrease" id="product2Decrease" type="button">&minus;</button>
								</div>
								<input type="number" id="product2amount" min="0" class="form-control text-center quantity-amount" value="1" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
								<div class="input-group-append">
								  <button class="btn btn-outline-black increase" id="product2Increase" type="button">&plus;</button>
								</div>
							  </div>
		  
							</td>
							<td id="priceIndicator2">₱750.00</td>
							<td><a href="#" class="btn btn-black btn-sm">X</a></td>
						  </tr>
						  ...
						  <tr>
							...
							<td class="product-name">
							  <h2 class="h5 text-black">Hoodie</h2>
							</td>
							<td>₱950.00</td>
							<td>
							  <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
								<div class="input-group-prepend">
								  <button class="btn btn-outline-black decrease" id="product3Decrease" type="button">&minus;</button>
								</div>
								<input type="number" id="product3amount" min="0" class="form-control text-center quantity-amount" value="1" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
								<div class="input-group-append">
								  <button class="btn btn-outline-black increase" id="product3Increase" type="button">&plus;</button>
								</div>
							  </div>
		  
							</td>
							<td id="priceIndicator3">₱950.00</td>
							<td><a href="#" class="btn btn-black btn-sm">X</a></td>
						  </tr>
						  ...
						  <tr>
							...
							<td class="product-name">
							  <h2 class="h5 text-black">Sweatshirt</h2>
							</td>
							<td>₱950.00</td>
							<td>
							  <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
								<div class="input-group-prepend">
								  <button class="btn btn-outline-black decrease" id="product4Decrease" type="button">&minus;</button>
								</div>
								<input type="number" id="product4amount" min="0" class="form-control text-center quantity-amount" value="1" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
								<div class="input-group-append">
								  <button class="btn btn-outline-black increase" id="product4Increase" type="button">&plus;</button>
								</div>
							  </div>
		  
							</td>
							<td id="priceIndicator4">₱950.00</td>
							<td><a href="#" class="btn btn-black btn-sm">X</a></td>
						  </tr>
